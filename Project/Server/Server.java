...
// UCID: mramos2001
// Date: 2025-07-07
// This snippet shows the server listening for incoming connections.
    ...
    private void start(int port) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            // UCID: mramos2001
            // Date: 2025-07-07
            // This snippet shows how the server handles multiple clients in separate threads.
    ...
    protected void createRoom(String name) throws DuplicateRoomException {
        ...
        Room room;
        if (nameCheck.equals("lobby")) {
            room = new Room(name); // basic chat lobby
        } else {
            room = new GameRoom(name); // all other rooms get RPS logic
        }
