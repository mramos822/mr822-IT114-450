...
public class Problem2 extends BaseClass {
    ...
    private static void sumValues(double[] arr, int arrayNumber) {
        ...
        // Plan:
        // 1. Loop through the array and calculate the sum of all values
        // 2. Store the total in a `double` variable
        // 3. Format the total to show exactly 2 decimal places using String.format
